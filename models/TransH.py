...
class TransH(Model):
    r'''
    To preserve the mapping properties of 1-N/N-1/N-N relations,
    TransH interprets a relation as a translating operation on a hyperplane.
    '''
    ...
    def loss_def(self):
        ...
        if config.train_weighted:
            w = self.get_weights(in_batch=False)
