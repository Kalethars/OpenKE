...
python3 result_mapper.py --method=WTransE_test
python3 result_recommendation.py --method=WTransE_test --unlimited=True
python3 recommendation_analyzer --method=WTransE_test --unlimited=True
cd ..CUDA_VISIBLE_DEVICES="1" python kg_test.py --method=WTransE_test --weighted=True